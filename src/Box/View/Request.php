...
class Request
{
    ...
    )
    {
        ...
        try {
            ...
            $response = $this->execute($guzzle, $request, $options, $timeout);
     ...
     * @throws BoxViewException
     */
    private function execute($guzzle, $request, $options, $timeout)
    {
        ...
        if (!empty($headers['Retry-After'])) {
            ...
            return $this->execute($guzzle, $request, $options, $timeout);
        }
